        ...
        <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <form action="{{route('update.home',$edithome->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="card-body">
                  <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                      <input type="text" class="form-control" name="subhead" value="{{$edithome->subhead}}">
                    </div>
                  </div>
                  ...
                  <div class="card-body">
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control" name="subhead2" value="{{$edithome->subhead2}}">
                      </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-4">
                          ...
                          <div class="col-sm-12 col-md-7">
                            <input type="text" class="form-control" name="note" value="{{$edithome->note}}">
                          </div>
                        </div>
                  ...
                  <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                      <textarea class="summernote-simple" name="description">{!! $edithome->description!!}</textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                      ...
                      <img src="{{asset($edithome->background_image)}}">
                    </div>
                  </div>
